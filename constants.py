...
BRICK_COLORS   = [colormodel.RED, colormodel.RED,colormodel.ORANGE,colormodel.ORANGE,colormodel.YELLOW,
                  colormodel.YELLOW,colormodel.GREEN, colormodel.GREEN, colormodel.CYAN, colormodel.CYAN]
...
STATE_COMPLETE  = 5
#: state when the game is moving to Level 2
STATE_LEVEL2    = 6
...
#: time to wait between putting up numbers of countdown
WAIT_TIME = 7
